  ...
  return (
    <Tab
      className={({ isSelected, isFocused, isHovered }) =>
        cn(
          `flex cursor-pointer items-center justify-center rounded-t border-b-[3px] px-1 pb-0.5 capitalize leading-6 text-light-gray shadow-[-3px_0px_0px] focus:outline-hidden focus:ring-0 [&>svg]:fill-light-gray`,
          {
